...
#include "AINiagaraInteractiveTool.generated.h"
 ...
 */
UCLASS()
class AINIAGARA_API UAINiagaraInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class AINIAGARA_API UAINiagaraInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class AINIAGARA_API UAINiagaraInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UAINiagaraInteractiveToolProperties> Properties;
