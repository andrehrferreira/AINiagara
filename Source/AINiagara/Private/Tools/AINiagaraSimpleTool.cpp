...
#define LOCTEXT_NAMESPACE "AINiagaraSimpleTool"

/*
 * ToolBuilder implementation
 */

UInteractiveTool* UAINiagaraSimpleToolBuilder::BuildTool(const FToolBuilderState& SceneState) const
{
	UAINiagaraSimpleTool* NewTool = NewObject<UAINiagaraSimpleTool>(SceneState.ToolManager);
...
void UAINiagaraSimpleTool::SetWorld(UWorld* World)
{
	this->TargetWorld = World;
}


void UAINiagaraSimpleTool::Setup()
{
	USingleClickTool::Setup();

	Properties = NewObject<UAINiagaraSimpleToolProperties>(this);
	AddToolPropertySource(Properties);
}


void UAINiagaraSimpleTool::OnClicked(const FInputDeviceRay& ClickPos)
{
