...
#include "AINiagaraEditorMode.generated.h"
 ...
 */
UCLASS()
class UAINiagaraEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_AINiagaraEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UAINiagaraEditorMode();
	virtual ~UAINiagaraEditorMode();
