...
// End Cross Module References
	...
	UAINiagaraInteractiveTool::~UAINiagaraInteractiveTool() {}
	struct Z_CompiledInDeferFile_FID_G__ToS_Plugins_AINiagara_Source_AINiagara_Private_Tools_AINiagaraInteractiveTool_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_G__ToS_Plugins_AINiagara_Source_AINiagara_Private_Tools_AINiagaraInteractiveTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAINiagaraInteractiveToolBuilder, UAINiagaraInteractiveToolBuilder::StaticClass, TEXT("UAINiagaraInteractiveToolBuilder"), &Z_Registration_Info_UClass_UAINiagaraInteractiveToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAINiagaraInteractiveToolBuilder), 2112209460U) },
		{ Z_Construct_UClass_UAINiagaraInteractiveToolProperties, UAINiagaraInteractiveToolProperties::StaticClass, TEXT("UAINiagaraInteractiveToolProperties"), &Z_Registration_Info_UClass_UAINiagaraInteractiveToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAINiagaraInteractiveToolProperties), 681256694U) },
		{ Z_Construct_UClass_UAINiagaraInteractiveTool, UAINiagaraInteractiveTool::StaticClass, TEXT("UAINiagaraInteractiveTool"), &Z_Registration_Info_UClass_UAINiagaraInteractiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAINiagaraInteractiveTool), 3690011584U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_G__ToS_Plugins_AINiagara_Source_AINiagara_Private_Tools_AINiagaraInteractiveTool_h_1203578558(TEXT("/Script/AINiagara"),
		Z_CompiledInDeferFile_FID_G__ToS_Plugins_AINiagara_Source_AINiagara_Private_Tools_AINiagaraInteractiveTool_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_G__ToS_Plugins_AINiagara_Source_AINiagara_Private_Tools_AINiagaraInteractiveTool_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
